  ...
  <div class="presentation">
    <section class="section section_0 active dev_wrapper" data-slide="1">
      <div class="wrapper lilo__wrapper">
        <div class="content__lilo">
          <img class="logo__big" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/logo-lilo-big.svg" alt="LILO">
          <img class="dots__purp" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/dots-purp.svg" alt="...">
        ...
        <img
          ...
          src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/woman_vr_blure.png"
          alt="blure"
        />
        <img
          class="background-img woman_vr"
          src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/woman_vr.png"
          alt="woman wearing vr glasses gaming"
        />
        <div class="background">
        </div>
        <div class="background_smoke">
          <img id="shadow_purp" style="opacity: 0.1;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/shadow_purp.svg" alt="" />
          <img id="shadow_blue" style="opacity: 0.1;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/shadow_blue.svg" alt="" />
        </div>
      </div>
    </section>
    <section class="section section_2" data-slide="2">
      <div class="wrapper">
        <div class="container-columns">
          <img class="shadow-purp" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_2/shadow purp.png" alt="" />
          <img class="twitch-bg-plaseholder twitch-opacity" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/twitch-bg.png" alt="">
          <div class="section2__column section2__column-twitch">
              <img
                class="twitch_logo streem_logo twitch-opacity"
                src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/twitch_logo.png"
                alt="twitch"
              />
              <img class="dust-purp-twitch twitch-opacity" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust-purp-twitch.png" alt="">
            ...
            <img class="shadow-blue" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_2/shadow blue.png" alt="" />
            <img class="vklay-bg-plaseholder vkplay-opacity" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/vkplay-bg.png" alt="">
            <div class="section2__column section2__column-vkplay">
              <img
                class="vkplay_logo streem_logo vkplay-opacity"
                src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/logo-vkplay1.svg"
                alt="vkplay"
              />
              <img class="dust-purp-vkplay vkplay-opacity" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust-blue-vkplay.png" alt="">
        ...
        <img class="woman_vr2" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/pict_girl.png" alt="girl"/>
    ...
    <section class="section section_3" data-slide="3">
      <div class="wrapper our_network__wrapper">
        ...
        <div>
          <video class="streem streem_3 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster.png">
            <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s3.mp4" type="video/mp4">
          </video>
        </div>
      </div>
      <img class="girl_streem" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_woman.png" alt="">
      <div class="background">
      </div>
      <div class="background_smoke">
        <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_3/shadow blue.png" alt="">
        <img class="bg bg-sky" style="z-index: -1;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-sky.png" alt="">
        </div>
    </section>
    <section class="section section_4 custom-bg" data-slide="4">
      <div class="wrapper">
        <div class="section_4-streem">
          <video class="streem streem_4 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster2.png"> 
            <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s4.mp4">
          </video>
          <div class="section4__info__wrapper">
            ...
            <img class="bg-section-card section-4-card-1" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <div class="section4__card">
              <div class="big_title">
            ...
            <img class="bg-section-card section-4-card-2" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
          </div>

        </div>
        <div class="background_smoke">
          <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_4/shadow blue.png" alt="" />
          <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_4/shadow purp.png" alt="" />
        </div>
      </div>
    </section>
    <section class="section section_5" data-slide="5">
      <div class="wrapper section_5-cards">
        <div class="section_5__wrapper__left">
          ...
          <img class="bg-blure-container section-5-card-1" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust purp-bg-2.png" alt="">
          <div class="blure_container section_5_blure__left purp-left">
            <div class="blure_container_content">
          ...
          <img class="bg-blure-container section-5-card-2" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust purp-bg-2.png" alt="">
        </div>
      ...
      <div class="background_smoke">
        <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_5/shadow blue.png" alt="" />
        <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_5/shadow purp.png" alt="" />
      </div>
    </section>
    <section class="section section_6 " data-slide="6">
      <div class="wrapper section__ads">
        <div class="section__ads">
          <div class="ads_info">
            ...
            <div class="ads_info__cards_container">
              <div class="ads_info__card block3__wrapper" data-format="in-stream">
                ...
                <img class="ads_info_cards_arrow" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/arrow-up.svg" alt=">">
              </div>
          ...
          <img class="line-to-left" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/line-to-left.svg" alt="">
          <img class="dust-up for-video" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust up.png" alt="">
          <img class="dust-down for-video" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust down.png" alt="">
        </div>
        <div class="ads_carusel__vertical">
            <div class="video-border">
              <video class="streem streem_6 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster3.png"> 
                <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/lilo_anim.mp4">
              </video>
            </div>
            <div class="video-border">
              <video class="streem streem_6 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster2.png"> 
                <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s4.mp4">
              </video>
            </div>
            <div class="video-border">
              <video class="streem streem_6 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster.png" > 
                <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s3.mp4">
              </video>
            </div>
          </div>
        <div class="background_smoke">
          <img id="shadow_purp" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/shadow_purp.svg" alt="" />
          <img id="shadow_blue" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/shadow_blue.svg" alt="" />
        </div>
      </div>
    </section>
    <section class="section section_7" data-slide="7">
      <div class="wrapper">
        <div class="section_7-streem">
          <img class="line-to-right" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/line-to-right.svg" alt="">
          <div class="video-border">
            <video class="streem streem_7 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster2.png"> 
              <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s4.mp4">
            </video>
          </div>
          <div class="section4__info__wrapper">
            ...
            <img class="bg-section-card section-7-card-1" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <div class="section4__card">
              <div class="big_title">
                80% - <span>VTR</span>
              </div>
            </div>
            <img class="bg-section-card section-7-card-2" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <div class="section4__card">
              <div class="big_title">
                80% - <span>Viewability</span>
              </div>
            </div>
            <img class="bg-section-card section-7-card-3" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
    ...
    <section class="section section_8 custom-bg" data-slide="8">
      <div class="wrapper eye__wrapper">
        <div class="section_7-streem">
          <img class="line-to-right" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/line-to-right.svg" alt="">
          <div class="video-border">
            <video class="streem streem_8 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster2.png"> 
              <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s4.mp4">
            </video>
          </div>
          <div class="section4__info__wrapper">
            ...
            <img class="bg-section-card section-8-card-1" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <div class="section4__card">
              <div class="big_title">
            ...
            <img class="bg-section-card section-8-card-2" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <a class="look_format" href="/" target="_blank">Посмотреть формат</a>
          </div>
        </div>
        <div class="background_smoke">
    ...
    <section class="section section_9 custom-bg" data-slide="9">
      <div class="wrapper">
        <div class="section_7-streem">
          <img class="line-to-right" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/line-to-right.svg" alt="">
          <div class="video-border">
            <video class="streem streem_8 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster.png"> 
              <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/streem_s3.mp4">
            </video>
          </div>
          <div class="section4__info__wrapper">
            ...
            <img class="bg-section-card section-9-card-1" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <a class="look_format" href="/" target="_blank">Посмотреть формат</a>
          </div>
    ...
    <section class="section section_10 custom-bg" data-slide="10">
      <div class="wrapper sales__wrapper">
        <div class="section_7-streem">
          <img class="line-to-right" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/line-to-right.svg" alt="">
          <div class="video-border">
            <video class="streem streem_8 lazy" autoplay muted loop poster="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/poster3.png"> 
              <source data-src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/lilo_anim.mp4">
            </video>
          </div>
          <div class="section4__info__wrapper">
            ...
            <img class="bg-section-card section-10-card-1" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
            <div class="section4__card">
              <div class="big_title">
            ...
            <img class="bg-section-card section-10-card-2" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg-blure-card.png" alt="">
          </div>
      ...
      <div class="wrapper">
        <div>
          <div class="flame_block_with_img_outline top__left">
            <img class="img__outline_planet" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/cyber_planet.png" alt="">
          ...
          <div class="flame_block_with_img_outline center__right">
            <img class="img__outline" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/locked.png" alt="">
            <div class="text_flame_block">
          ...
          <div class="flame_block_with_img_outline bottom_left">
            <img class="img__outline" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/coins.png" alt="">
            <div class="text_flame_block">
        ...
        <div class="background_smoke">
          <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_11/shadow blue.png" alt="" />
          <img class="bg" style="opacity: 0.3;" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/slide_11/shadow purp.png" alt="" />
        </div>
      </div>
    </section>
      ...
      <div class="wrapper needed_section">
        <div class="needed_col__wrapper">
          <div class="needed_col reserv_col">
            <img class="needed__image shild" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/cyber_shild.png" alt="shild">
          ...
          <img class="bg-needed_col__image shild" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust-purp-12.png" alt="bg-dust-purp-12">
          <div class="needed_col create_col">
            <img class="needed__image figma" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/figma_purp.png" alt="figma">
          ...
          <img class="bg-needed_col__image figma" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust-purp-12.png" alt="bg-dust-purp-12">
          <div class="needed_col start_col">
            <img class="needed__image roket" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/roket.png" alt="roket">
          ...
          <img class="bg-needed_col__image roket" src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/bg/dust-purp-12.png" alt="bg-dust-purp-12">
        </div>
    ...
    <section class="section section_13" data-slide="13">
      <div class="wrapper lilo__wrapper">
        ...
        <img
          class="background-img woman_vr"
          src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/girl_witcher.png"
          alt="woman wearing vr glasses gaming"
        />
        <div class="background">
        </div>
...
<div class="p-nav">
  ...
  <div class="p-nav__panel">
    <div class="p-nav__left"><img src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/angle.svg" alt=""></div>
    <div class="p-nav__number">1</div>
    <div class="p-nav__right"><img src="<?php echo get_stylesheet_directory_uri(); ?>/lilo/img/angle.svg" alt=""></div>
  </div>
</div>
<?php get_footer('lilo');?>